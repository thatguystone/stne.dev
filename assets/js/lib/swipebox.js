	...
	$.swipebox = function( elem, options ) {
		...
		ui = {
			...
			setDim : function () {
				...
				$( '#swipebox-overlay, #swipebox-background' ).css( sliderCss );
			...
			actions : function (isTouch) {
				...
				if ( elements.length < 2 ) {
					...
					$( '#swipebox-prev' ).bind( action, prev );
					$( '#swipebox-next' ).bind( action, next );
				}
			...
			destroy : function () {
				...
				$( '#swipebox-overlay, #swipebox-background' ).fadeOut('fast', function() {
					$(this).remove();
				});
