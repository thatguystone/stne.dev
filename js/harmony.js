var
	REV = 6,
	BRUSHES_SELECT = ["sketchy", "shaded", "chrome", "ribbon", "circles"],
	BRUSHES = BRUSHES_SELECT[(function(min, max) { return Math.floor(Math.random() * (max - min + 1)) + min; })(0, BRUSHES_SELECT.length)], 
